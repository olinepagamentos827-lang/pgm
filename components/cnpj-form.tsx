  ...
  return (
    <form onSubmit={handleSubmit} className="p-6 font-sans">
      <div className="mx-auto max-w-[350px]">
        <div className="mb-4">
          <label htmlFor="cnpj" className="block text-sm font-bold text-[#333] mb-1.5">
            CNPJ completo:
          </label>
          <input
            type="text"
        ...
        <div className="text-left">
          <button
            type="submit"
            disabled={loading}
            className="inline-flex items-center justify-center rounded border border-[#4cae4c] bg-gradient-to-b from-[#5cb85c] to-[#449d44] px-4 py-1.5 text-sm font-medium text-white shadow-sm hover:from-[#449d44] hover:to-[#419641] transition-all cursor-pointer disabled:opacity-80 disabled:cursor-not-allowed min-w-[90px]"
          >
            {loading ? (
